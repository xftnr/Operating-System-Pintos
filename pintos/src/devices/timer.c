...
/* List of processes in THREAD_BLOCKED state because it called timer_sleep. */
...
/*
* Compare the time to wake up between two threads
*
* a - the element to be inserted
* b - the element already in the list
*
* return true if the wake up time for a is less than that of b
*/
